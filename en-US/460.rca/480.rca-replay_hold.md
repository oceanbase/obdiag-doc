...
|slug|oceanbase-cluster-replay-hold|

# Root cause analysis scenario: OceanBase cluster playback card

<main id="notice" type='explain'>
  <h4>Description</h4>
  <p>obdiag supports root cause analysis of OceanBase cluster playback card scenarios since V3.6.0. </p>
</main>

## Applicable scenarios

This article applies to the OceanBase cluster playback card scenario, and is analyzed based on the OceanBase database internal table data and logs.

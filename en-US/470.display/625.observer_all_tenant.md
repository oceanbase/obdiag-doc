...
This article is applicable to the scenario of independent deployment of obdiag. It can be executed with one click to display all the tenants of the OceanBase cluster.

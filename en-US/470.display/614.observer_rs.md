...
This article is applicable to the scenario of independent deployment of obdiag. It can be executed with one click to display the RS (Root Service) information of the cluster on the terminal.

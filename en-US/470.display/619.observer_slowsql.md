...
This article is applicable to the scenario of independent deployment of obdiag. It can be executed with one click to display the slowsql information of the cluster in the terminal.
...
<main id="notice" type='explain'>
  <h4>Description</h4>
  <p>In the parameter <code>--env</code>, <code>mtime</code> refers to the latest slowsql time, in minutes. </p>
</main>
...
```shell
# Use --env for tenant connection; last 10 minutes of slow SQL

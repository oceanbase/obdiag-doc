...
This article is applicable to the scenario of independent deployment of obdiag. It can be executed with one click to display the node information of the cluster on the terminal.

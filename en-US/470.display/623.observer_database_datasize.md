...
This article is applicable to the scenario of independent deployment of obdiag. It can be executed with one click to display the disk usage of the specified database.
...
| --env | Yes | string | Default is empty | Additional parameters required for obdiag display, fixed style: `--env tenant_id=1 --env database_name=test`. |

...
- **Offline deployment (no access to external network)**
    ...
    Download the latest version of OceanBase agile diagnostic tool (obdiag) from the OceanBase official website [download page] (https://www.oceanbase.com/softwarecenter).
...
```bash
    ...
    After downloading the RPM package of obdiag from [Download Page](https://www.oceanbase.com/softwarecenter), convert to DEB and install:
...
```bash
    ...
    After downloading the RPM package of obdiag from [Download Page](https://www.oceanbase.com/softwarecenter):

...
+---+----------------------------------+-------------+----------------------+
| 18| px_task                          | 2.758 ms    | OBSERVER(192.168.1.1)|
| 5 | pc_get_plan                      | 52 μs       | OBSERVER(192.168.1.1)|
| 16| do_local_das_task                | 45 μs       | OBSERVER(192.168.1.1)|     
| 10| do_local_das_task                | 17 μs       | OBSERVER(192.168.1.1)|
| 17| close_das_task                   | 14 μs       | OBSERVER(192.168.1.1)|     
+---+----------------------------------+-------------+----------------------+
Tags & Logs:
-------------------------------------
18 - px_task  Elapsed: 2.758 ms 
     NODE:OBSERVER(192.168.1.1)
     tags: [{'group_id': 0}, {'qc_id': 1}, {'sqc_id': 0}, {'dfo_id': 1}, {'task_id': 1}]
5 - pc_get_plan  Elapsed: 52 μs 
    NODE:OBSERVER(192.168.1.1)
16 - do_local_das_task  Elapsed: 45 μs 
     NODE:OBSERVER(192.168.1.3)
...
+---+----------------------------------+-------------+----------------------+
| 1 | TRACE                            | -           | -                    |
| 2 | └─com_query_process              | 5.351 ms    | OBPROXY(192.168.1.1) |
| 3 |   └─mpquery_single_stmt          | 5.333 ms    | OBSERVER(192.168.1.1)|
| 4 |     ├─sql_compile                | 107 μs      | OBSERVER(192.168.1.1)|
| 5 |     │ └─pc_get_plan              | 52 μs       | OBSERVER(192.168.1.1)|
| 6 |     └─sql_execute                | 5.147 ms    | OBSERVER(192.168.1.1)|
| 7 |       ├─open                     | 87 μs       | OBSERVER(192.168.1.1)|
| 8 |       ├─response_result          | 4.945 ms    | OBSERVER(192.168.1.1)|
| 9 |       │ ├─px_schedule            | 2.465 ms    | OBSERVER(192.168.1.1)|
| 10|       │ │ ├─do_local_das_task    | 17 μs       | OBSERVER(192.168.1.1)|
| 11|       │ │ ├─px_task              | 2.339 ms    | OBSERVER(192.168.1.2)|
| 12|       │ │ │ ├─do_local_das_task  | 54 μs       | OBSERVER(192.168.1.2)|
| 13|       │ │ │ └─close_das_task     | 22 μs       | OBSERVER(192.168.1.2)|
| 14|       │ │ ├─do_local_das_task    | 11 μs       | OBSERVER(192.168.1.1)|
| 15|       │ │ ├─px_task              | 2.834 ms    | OBSERVER(192.168.1.3)|
| 16|       │ │ │ ├─do_local_das_task  | 45 μs       | OBSERVER(192.168.1.3)|
| 17|       │ │ │ └─close_das_task     | 14 μs       | OBSERVER(192.168.1.3)|
| 18|       │ │ └─px_task              | 2.758 ms    | OBSERVER(192.168.1.1)|
| 19|       │ ├─px_schedule            | 1 μs        | OBSERVER(192.168.1.1)|
| 20|       │ └─px_schedule            | 1 μs        | OBSERVER(192.168.1.1)|
| ..|       ......                     | ...         |  ......              |
+---+----------------------------------+-------------+----------------------+
...
| 19|       │ ├─px_schedule            | 1 μs        | OBSERVER(192.168.1.1)|
| 20|       │ └─px_schedule            | 1 μs        | OBSERVER(192.168.1.1)|
| 21|       └─close                    | 70 μs       | OBSERVER(192.168.1.1)|
| 22|         └─end_transaction        | 3 μs        | OBSERVER(192.168.1.1)|
+---+----------------------------------+-------------+----------------------+
Tags & Logs:
-------------------------------------
1 -   
2 - com_query_process  Elapsed: 5.351 ms 
    NODE:OBPROXY(192.168.1.1)

...
|slug|clog-disk-is-full-clog_disk_full|

# 根因分析场景：clog 盘满 clog_disk_full

## 适用场景

本文适用于 clog 盘满的场景，依赖内部表数据进行分析。
...
根据如下输出可发现节点中的 1005 日志流存在回放问题，需要进一步追踪。
...
[OceanBase诊断调优 (十二) ——clog盘满问题排查](https://open.oceanbase.com/blog/12986354194)

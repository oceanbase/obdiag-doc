...
|slug|executing-ddl-and-reporting-disk-full-error-ddl_disk_full|
...
| index_name    | 是    | string | ""        | 索引名称。<main id="notice" type='explain'><h4>说明</h4><p>自 obdiag V4.2.0 起支持配置多个索引，多个索引间使用英文逗号（<code>,</code>）分隔，如 <code>idx1,idx2,idx3</code>，按节点累计各索引预估大小。</p></main> |

...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p></a> 参数 --env 中 db_connect='-h127.0.0.1 -P2881 -utest@test -p****** -Dxxxx' 是业务租户的连接串信息是非必填项 </p>
  <p></a> 参数 --env 中 mtime 是只查看最新多长时间的 topsql, 单位分钟 </p>
</main>
...
```shell
# 通过额外传递 --env 参数来指定查询的租户连接串10分钟的 topsql
...
<main id="notice" type='notice'>
  <h4>说明</h4>
  <p>展示的结果按照QPS排序，ELAPSED_TIME_AVG 展示的是平均运行时间，单位为: 微秒</p>
</main>

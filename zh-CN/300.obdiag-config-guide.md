...
所有的配置都在 `{obdiag_install_path}/conf/` 目录下的 `config.yml` 中，配置文件的默认路径为 `/usr/local/oceanbase-diagnostic-tool/conf/config.yml`，请直接修改该配置文件。

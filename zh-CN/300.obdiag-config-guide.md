...
<main id="notice" type='explain'>
  ...
  <li><p>如果您的 OceanBase 集群为 docker 方式部署，配置文件可参考 <code>~/.obdiag/example/docker_ob_cluster.yml</code></p></li>
  <li><p>如果您的 OceanBase 集群为通过 ob-operator(k8s) 方式部署，配置文件可参考 <code>~/.obdiag/example/operator.yml</code></p></li>
  </ul>
</main>

...
| sys_user | 是 | OceanBase 集群sys 租户的连接用户，为避免权限问题建议使用 'root@sys' |
...
```
执行obdiag config后会出现交互形式的输入，请填写正确的信息
```bash
#obdiag config -h11.162.218.126 -uroot@sys -P3881
...
Enter your oceanbase host ssh username (default:''): test # ssh到各主机的用户名
Enter your oceanbase host ssh password (default:''): ********* # ssh到各主机的用户对应的密码
Enter your oceanbase host ssh_port (default:'22'): 22 # ssh 的端口号，默认是22
Enter your oceanbase install home_path (default:'/root/observer'): /home/admin/oceanbase # ob部署的安装目录
Enter your oceanbase data_dir (default:'/home/admin/oceanbase/store'): # ob部署的数据盘目录
Enter your oceanbase redo_dir (default:'/home/admin/oceanbase/store'): # ob部署的redo数据的目录

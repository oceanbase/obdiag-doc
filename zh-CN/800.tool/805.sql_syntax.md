...
<main id="notice" type='explain'>
  ...
  <li>本工具与基于规则的批量 SQL 审核不同：<code>obdiag analyze sql</code>/<code>obdiag analyze sql_review</code> 走内置 Review 规则并出报告。具体介绍可参见 <a href="../450.analyze/509.analyze_sql.md">SQL 审计分析与规则审核</a>、<a href="../450.analyze/510.analyze_sql_review.md">SQL 文件审核</a>。</li>
  </ul>
</main>

...
| --inner_config | 否    | string | 默认为空                    | obdiag 自用的配置。  固定样式：inner_config key1=value1 --config key2=value2。  <main id="notice" type='explain'><h4>说明</h4><p>支持通过该选项配置的参数可参见 <a href="../../300.obdiag-config-guide.md">系统配置文件（obdiag 自用的配置）章节</a>。</p></main>                                                                                 |

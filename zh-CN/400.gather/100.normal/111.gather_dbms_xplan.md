...
本文适用于独立部署 obdiag 的场景，使用 obdiag gather dbms_xplan 命令可以一键收集 SQL 的 DBMS_XPLAN 信息。
...
| --scope        | 否    | string | all                     | 选择收集的 SQL DBMS_XPLAN 的信息，可配置值为 `opt_trace、display_cursor、all`。                               |

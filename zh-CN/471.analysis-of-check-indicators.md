...
本文对 obdiag V1.5.0 版本的巡检指标来源进行解释。
...
|          | parameter                            | 内核参数是否按要求配置 T。可参考 [主机标准化检查项](https://www.oceanbase.com/docs/enterprise-oceanbase-ocp-cn-1000000000125643)                       |
|          | ulimit_parameter                     | ulimit 相关参数是否按要求配置T。可参考 [主机标准化检查项](https://www.oceanbase.com/docs/enterprise-oceanbase-ocp-cn-1000000000125643)                 |

...
如果你的待诊断集群是 OBD 部署的，建议升级 OBD 到 V2.5.0 及以上版本，可通过 OBD 的命令直接使用 obdiag 工具，无需配置~/.obdiag/config.yml文件，详细命令可参考 [诊断工具命令组](https://www.oceanbase.com/docs/community-obd-cn-10000000002049483)。

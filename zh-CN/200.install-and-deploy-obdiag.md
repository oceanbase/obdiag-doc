...
本文将介绍安装 obdiag 的方法。如果您想在线体验功能，请移步[在线体验](https://www.oceanbase.com/demo/obdiag)
...
- 在线部署（可访问外网的情况下可选择）
    ...
    <main id="notice" type='explain'>
      <h4>说明</h4>
      <p>在线部署的方式支持 centos7/8，暂不支持 centos9，如果是 centos9 请参照下面的离线部署方式。</p>
    </main>

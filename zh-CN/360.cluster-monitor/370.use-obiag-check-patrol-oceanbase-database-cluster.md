...
|------------------|------|--------|------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| --cases          | 否    | string | ``                     | 需要执行的 OceanBase 数据库巡检项目的集合名。当未赋值时执行所有的 tasks。                                                                                                                                                        |
| --obproxy_cases  | 否    | string | ``                     | 需要执行的 OBProxy 巡检项目的集合名。当未赋值时执行所有的 tasks。                                                                                                                                                             |
...
| --observer_tasks | 否    | string | 默认为空                   | 指定执行observer的tasks，多个tasks用;分隔。支持正则表达式                                                                                                                                                               |
| --obproxy_tasks  | 否    | string | 默认为空                   | 指定执行obproxy的tasks，多个tasks用;分隔。支持正则表达式                                                                                                                                                                |

...
|          | sysbench_test_tenant_cpu_parameters  | max_iops 应该为 max_cpu *10000 以上；                                                         min_iops 应该为 min_cpu* 10000 以上                      |
| bugs     | bug_182                              | 相关信息参考https://github.com/oceanbase/obdiag/issues/182                                                         min_iops 应该为 min_cpu* 10000 以上 |
| table    | information_schema_tables_two_data   | 确认是否有表在information_schema.tables中存在两条记录                                                         min_iops 应该为 min_cpu* 10000 以上              |
